...
SECTION = "libs"
LICENSE = "(Apache-2.0)"
LIC_FILES_CHKSUM = "file://${S}/lib_binaries/licenses/LICENSE;md5=0ba5044c64ef53cb0189c9546081e228"

SRC_URI = " \
	file://lib_tvm.tar.gz;subdir=sources \
"
...
do_install() {
	install -d ${D}${libdir}/
	install -m 0755 ${S}/lib_binaries/libtvm_runtime.so* ${D}${libdir}/
